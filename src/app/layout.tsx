...
export const metadata: Metadata = {
  title: "Good Game - Premium Toys for Kids | Safe & Educational",
  description: "Discover quality toys for children at Good Game. Safe, affordable, and fun toys including educational games, building blocks, and more for all ages.",
  keywords: "toys for kids, educational toys, toy store, children's toys, toy shop",
  openGraph: {
    title: "Good Game - Premium Toys for Kids",
    description: "Quality toys that inspire imagination and creativity in every child.",
    type: "website",
    siteName: "Good Game"
  },
  twitter: {
